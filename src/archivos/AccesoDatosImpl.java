...
public class AccesoDatosImpl implements IAccesoDatos {
    ...
    public void crearDirectorio(String dirName) {
        File file = new File(dirName.toUpperCase());
        file.mkdir();
    }
    ...
    public void crearArchivo(String fileName) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "No se pudo crear el archivo, ERROR: " + ex.getMessage());
        }
    }
    ...
    @Override
    public boolean borrar(String fileName) {
        File file = new File(fileName.toUpperCase());
        return file.delete();
    }
    ...
    public Map obtenerRegistros(TypoRegistro list, String path) {
        ...
        switch (list) {
            ...
            case ESTABLECIMIENTOS:
                ...
                for (int i = 0; i < dataFromFile.size(); i++) {
                    String[] line = dataFromFile.get(i).split(",");
                    establecimiento = new Establecimiento(Integer.parseInt(line[0]), line[1], line[2], line[3], line[4]);
                    registros.put(establecimiento.getCodigo(), establecimiento);
                }
                break;
            case CURSOS:
                Curso curso;
